...
1) To store your code, while also keeping the ability to pull updates from our version of this repo, 
...
2) Now we will configure the Duckietown version of this repository as the upstream repository to synchronize 
   with your fork. Navigate to the repository folder and then list the current remote repository for your fork,
    ...
    You can now push your work to your repository using the standard GitHub workflow, and the beginning of every 
...
And that is it! You are ready to move on to the next section and start your development journey with 
